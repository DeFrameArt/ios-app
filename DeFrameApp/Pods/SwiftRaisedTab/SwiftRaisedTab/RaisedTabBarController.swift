...
open class RaisedTabBarController: UITabBarController {
    ...
    open func insertEmptyTabItem(title: String, atIndex: Int) {
    ...
    open func addRaisedButton(buttonImage: UIImage?, highlightImage: UIImage?) {
        if let buttonImage = buttonImage {
            ...
            button.addTarget(self, action: "onRaisedButton:", for: UIControlEvents.touchUpInside)
            self.view.addSubview(button)
        }
    }
    
    open func onRaisedButton(sender: UIButton!) {
